...
# image clipped when lights on, mask not good
        ...
        hsv_lower_limit = np.array([80,1,100])
        hsv_upper_limit = np.array([100,40,255])
        print(hsv_lower_limit);
