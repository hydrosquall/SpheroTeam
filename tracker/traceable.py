...
#import tracker
from graphics import ImageGraphics as Ig
from sample import TrackingSample
from util2 import Color
from util2 import Vector2D
...
class TraceableObject(object):
    ...
    def draw_name(self, image):
        ...
        """
        try:
            Ig.draw_text(image, self.object_name, self.pos + (15, 5), 0.35, Color((255, 0, 255)))
        except TypeError:
